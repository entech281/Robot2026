...
public class DriveOutput extends SubsystemOutput {
  ...
  public void toLog() {
    ...
    Logger.recordOutput("DriveOutput/virtualAbsoluteEncoders",
        virtualAbsoluteEncoders);
    Logger.recordOutput("DriveOutput/moduleStates", moduleStates);
    Logger.recordOutput("DriveOutput/chassisSpeed", speeds);

    Logger.recordOutput("DriveOutput/drivePositions/frontLeft",
        drivePositions.get(0));
    Logger.recordOutput("DriveOutput/drivePositions/frontRight",
        drivePositions.get(1));
    Logger.recordOutput("DriveOutput/drivePositions/rearLeft",
        drivePositions.get(2));
    Logger.recordOutput("DriveOutput/drivePositions/rearRight",
        drivePositions.get(3));

    Logger.recordOutput("DriveOutput/turnPosition/frontLeft",
        turningPositions.get(0));
    Logger.recordOutput("DriveOutput/turnPosition/frontRight",
        turningPositions.get(1));
    Logger.recordOutput("DriveOutput/turnPosition/rearLeft",
        turningPositions.get(2));
    Logger.recordOutput("DriveOutput/turnPosition/rearRight",
        turningPositions.get(3));
